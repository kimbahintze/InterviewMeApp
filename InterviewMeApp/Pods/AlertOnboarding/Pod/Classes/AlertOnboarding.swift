...
//    open var colorButtonText: UIColor = UIColor(red: 118/255, green: 125/255, blue: 152/255, alpha: 1.0)
    ...
    open var colorButtonBottomBackground: UIColor = UIColor(red: 44/255, green: 212/255, blue: 140/255, alpha: 1.0)

    open var colorButtonText: UIColor = UIColor(red: 255/255, green: 255/255, blue: 255/255, alpha: 1.0)
    
    open var colorTitleLabel: UIColor = UIColor.black
    
    open var colorDescriptionLabel: UIColor = UIColor(red: 118/255, green: 125/255, blue: 152/255, alpha: 1.0)
